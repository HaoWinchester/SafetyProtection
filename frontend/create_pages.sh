...
# Create all remaining User Center pages

# Auth Page
mkdir -p "/Users/menghao/Documents/幻谱/大模型安全检测工具/SafetyProtection/frontend/src/pages/UserCenter/Auth"
cat > "/Users/menghao/Documents/幻谱/大模型安全检测工具/SafetyProtection/frontend/src/pages/UserCenter/Auth/index.tsx" << 'EOF'
/**
 * 授权管理页面
...
echo "Created Auth page successfully"
