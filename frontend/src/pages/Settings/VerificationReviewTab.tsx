  ...
  return (
    <div>
      ...
      <Row gutter={16} style={{ marginBottom: 24 }}>
        ...
        <Col span={6}>
          <Card>
            <Title level={4} style={{ margin: 0, color: '#1890ff' }}>{stats.pending}</Title>
            <Text type="secondary">待审核</Text>
          </Card>
        </Col>
        <Col span={6}>
          <Card>
            <Title level={4} style={{ margin: 0, color: '#52c41a' }}>{stats.approved}</Title>
            <Text type="secondary">已通过</Text>
          </Card>
        </Col>
        <Col span={6}>
          <Card>
            <Title level={4} style={{ margin: 0, color: '#f5222d' }}>{stats.rejected}</Title>
